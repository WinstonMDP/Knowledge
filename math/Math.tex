...
\begin{document}
    ...
    \end{flalign*}
    \begin{flalign*}
        \forall x \ \overline{x R x}
        \Leftrightarrow
        R - \text{иррефлексивное}.
    \end{flalign*}
    \begin{flalign*}
        \forall x, y \ \left(x R y \longrightarrow y R x\right)
        \Leftrightarrow
        R - \text{симметричное}.
    \end{flalign*}
    \begin{flalign*}
    ...
    \begin{flalign*}
        R = R^{-1}
        \Leftrightarrow
        R - \text{симметричность}.
    \end{flalign*}
    \begin{flalign*}
        R \cap R^{-1} \subseteq id
        \Leftrightarrow
        R - \text{антисимметричное}.
    \end{flalign*}
    \begin{flalign*}
    ...
    \begin{flalign*}
        ...
        \right.
        \longrightarrow
        P \cap Q - \text{транзитивное}.
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
            &P \subseteq A^2 \\
            &P - \text{иррефлексивное}. \\
            &P - \text{транзитивное}.
        \end{aligned}
        \right.
        \Leftrightarrow
        P - \text{строгий частичный порядок на} \ A.
    \end{flalign*}
    \begin{flalign*}
        \exists A \ P - \text{строгий частичный порядок на} \ A.
        \longrightarrow
        P - \text{антисимметричное}.
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
        ...
        \right.
        \Leftrightarrow
        P - \text{нестрогий частичный порядок на} \ A.
    \end{flalign*}
    \begin{flalign*}
        \varphi\left(P\right) = P \cup id
    \end{flalign*}
    \begin{flalign*}
        \psi\left(P\right) = P \ \backslash \ id
    \end{flalign*}
    \begin{flalign*}
        S\left(A\right) - \text{множество строгих частичных порядков на} \ A.
    \end{flalign*}
    \begin{flalign*}
        N\left(A\right) - \text{множество нестрогих частичных порядков на} \ A.
    \end{flalign*}
    \begin{flalign*}
        S\left(A\right) \stackrel{\varphi}{\sim} N\left(A\right)
    \end{flalign*}
    \begin{flalign*}
        S\left(A\right) \stackrel{\psi}{\sim} N\left(A\right)
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
            &< - \text{строгий частичный порядок на} \ A. \\
            &\leq - \text{нестрогий частичный порядок на} \ A. \\
            &< = \psi(\leq)
        \end{aligned}
        \right.
        \Leftrightarrow
        \left(A, <, \leq\right) - \text{частично упорядоченное множество}.
    \end{flalign*}
    \begin{flalign*}
        \left(A, <, \leq\right) - \text{частично упорядоченное множество}.
        \Leftrightarrow
        A - \text{носитель порядка} \ \left(A, <, \leq\right).
    \end{flalign*}
    \begin{flalign*}
        \forall y \in B \ \overline{y < x}
        \Leftrightarrow
        x - \text{минимальное в} \ B.
    \end{flalign*}
    \begin{flalign*}
        \forall y \in B \ \overline{x < y}
        \Leftrightarrow
        x - \text{максимальное в} \ B.
    \end{flalign*}
    \begin{flalign*}
        \forall y \in B \ x \leq y
        \Leftrightarrow
        x - \text{наименьший в} \ B.
    \end{flalign*}
    \begin{flalign*}
        \forall y \in B \ y \leq x
        \Leftrightarrow
        x - \text{наибольший в} \ B.
    \end{flalign*}
    \begin{flalign*}
        x - \text{наименьший в} \ B.
        \longrightarrow
    ...
    \end{flalign*}
    \begin{flalign*}
        \exists! x - \text{наименьший в} \ B.
    \end{flalign*}
    \begin{flalign*}
        \exists! x - \text{наибольший в} \ B.
    \end{flalign*}
    \begin{flalign*}
        B^{\triangle} (\text{множество верхних граней} \ B)
        =
        \set{x \in A \ \left| \ \forall y \in B \ y \leq x\right.}
    \end{flalign*}
    \begin{flalign*}
        B^{\triangledown} (\text{множество нижних граней} \ B)
        =
        \set{x \in A \ \left| \ \forall y \in B \ x \leq y\right.}
    \end{flalign*}
    \begin{flalign*}
        \left(B \cup C\right)^{\triangle} = B^{\triangle} \cap C^{\triangle}
    \end{flalign*}
    \begin{flalign*}
        \left(B \cup C\right)^{\triangledown} = B^{\triangledown} \cap C^{\triangledown}
    \end{flalign*}
    \begin{flalign*}
        B \subseteq C
        \longrightarrow
        B^{\triangle} \subseteq C^{\triangle}
    \end{flalign*}
    \begin{flalign*}
        B \subseteq C
        \longrightarrow 
        C^{\triangledown} \subseteq B^{\triangledown}
    \end{flalign*}
    \begin{flalign*}
        B \subseteq B^{\triangle \triangledown} \cap B^{\triangledown \triangle}
    \end{flalign*}
    \begin{flalign*}
        B^{\triangledown} = B^{\triangledown \triangle \triangledown}
    \end{flalign*}
    \begin{flalign*}
        B^{\triangle} = B^{\triangle \triangledown \triangle}
    \end{flalign*}
    \begin{flalign*}
        sup_{<} B = \text{наименьший} \ B^{\triangle}
    \end{flalign*}
    \begin{flalign*}
        inf_{<} B = \text{наибольший} \ B^{\triangledown}
    \end{flalign*}
    \begin{flalign*}
        \left(A, <\right) - \text{решётка}.
        \Leftrightarrow
        \forall a, b \in A \ \exists
        \left\{
        \begin{aligned}
            &\sup_{<}\set{a, b} \\
            &\inf_{<}\set{a, b}
    ...
    \end{flalign*}
    \begin{flalign*}
        \left(A, <\right) - \text{линейно упорядоченное множество}.
        \Leftrightarrow
        \forall x, y \in A \
        \left[
        \begin{aligned}
    ...
    \begin{flalign*}
        \left(A, <\right) - \text{линейно упорядоченное множество}.
        \longrightarrow
        \forall x, y \in A \ \left(\overline{x < y} \Leftrightarrow y \leq x\right)
    \end{flalign*}
    \begin{flalign*}
        \left(A, <\right) - \text{линейно упорядоченное множество}.
        \longrightarrow
    ...
    \begin{flalign*}
        \left\{
        \begin{aligned}
            &\left(A, <\right) - \text{частично упорядоченное множество}. \\
            &C \subseteq A \\
            &\left(C, <\right) - \text{линейно упорядоченное множество}.
        \end{aligned}
        \right.
        \Leftrightarrow
        C - \text{цепь в} \ \left(A, <\right).
    \end{flalign*}
    \begin{flalign*}
        \forall x, y \in C \
        \left\{
    ...
    \begin{flalign*}
        ...
        \begin{aligned}
            ...
            &A \stackrel{\alpha}{\sim} B \\
            &\left(x <_A y \Leftrightarrow \alpha(x) <_{\beta} \alpha(y)\right)
        \end{aligned}
        \right.
        \Leftrightarrow
        \left(A, <_A\right)
        \stackrel{\alpha}{\cong} (\text{изоморфно})
        \left(B, <_B\right)
    \end{flalign*}
    \begin{flalign*}
        A \cong A
    \end{flalign*}
    \begin{flalign*}
        A \stackrel{\alpha}{\cong} B
        \longrightarrow
        B \stackrel{\alpha^{-1}}{\cong} A
    \end{flalign*}
    \begin{flalign*}
        \forall B \
        \left\{
        \begin{aligned}
            &A \stackrel{\alpha}{\cong} B \\
            &B \stackrel{\beta}{\cong} C
        \end{aligned}
        \right.
        \longrightarrow
        A \stackrel{\alpha \circ \beta}{\cong} C
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
        ...
        \right.
        \Leftrightarrow
        P - \text{отношение эквивалентности на} \ A.
    \end{flalign*}
    \begin{flalign*}
        Eq\left(A\right) - \text{множество отношений эквивалентности на} \ A.
    \end{flalign*}
    \begin{flalign*}
        E \in Eq(A) \ id_A \subseteq E \subseteq A^2
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
            &E \in Eq\left(A\right) \\
            &x \in A
        \end{aligned}
        \right.
        \Leftrightarrow
        [x]_E (\text{класс эквивалентности}) = \set{y \in A \ \left| \ x E y\right.}
    \end{flalign*}
    \begin{flalign*}
        A/E (\text{фактор-множество мн-ва $ A $ по отн-нию экв-сти $ E $})
        =
        \set{\left.[x]_E \in P(A) \ \right| \ x \in E}
    \end{flalign*}
    \begin{flalign*}
        \forall B \ f: A \longrightarrow B \
        ker \ f = \set{\left.(x, y) \in A^2 \ \right| \ f(x) = f(y)}
    \end{flalign*}
    \begin{flalign*}
        f: A \longrightarrow B \ ker \ f \in Eq\left(A\right)
    \end{flalign*}
    \begin{flalign*}
        ker \ f = id
        \Leftrightarrow
    ...
    \end{flalign*}
    \begin{flalign*}
        E \in Eq(A) \ P_E: A \longrightarrow A/E \ P_E(x) = [x]_E
    \end{flalign*}
    \begin{flalign*}
        x E y \Leftrightarrow [x]_E = [y]_E
    \end{flalign*}
    \begin{flalign*}
        [x]_E = [y]_E \Leftrightarrow [x]_E \cap [y]_E = \varnothing
    \end{flalign*}
    \begin{flalign*}
        x \in [x]_E
    \end{flalign*}
    \begin{flalign*}
        \forall x \in A \ \exists \sigma \in \Sigma \ 
        \left\{
        \begin{aligned}
            &\Sigma \subseteq \mathcal{P}\left(A\right) \\
            &x \in \sigma \\
            &\sigma \cap \tau = \varnothing \Leftrightarrow \sigma \neq \tau \\
            &\sigma \neq \varnothing
        \end{aligned}
        \right.
        \Leftrightarrow
        \Sigma - \text{разбиение} \ A.
    \end{flalign*}
    \begin{flalign*}
        \Pi\left(A\right) - \text{множество разбиений} \ A.
    \end{flalign*}
    \begin{flalign*}
        Eq\left(A\right) \sim \Pi\left(A\right)
    \end{flalign*}
    ...
    \begin{flalign*}
        \forall G, \ H \
        ord \ G \times H = ord \ G \ ord \ H
    \end{flalign*}
    \begin{flalign*}
        \forall g, \ h \
        ord \ (g, \ h) = \text{НОК}(ord \ g, \ ord \ h)
	\end{flalign*}
    \begin{flalign*}
        \forall G, \ H \
        \left(
        \left\{
        \begin{aligned}
            &\text{НОД}\left(ord \ G, \ ord \ H\right) = 1 \\
            &G - \text{циклическая}. \\
            &H - \text{циклическая}.
        \end{aligned}
        \right.
        \longrightarrow
        G \times H - \text{циклическая}.
        \right)
	\end{flalign*}
    \begin{flalign*}
        \forall G, \ H, \ n, \ m \
        ...
        \times
        \left(\mathbb{Z}/m\mathbb{Z}\right)
        \simeq
        \left(\mathbb{Z}/nm\mathbb{Z}\right)
        \right)
	\end{flalign*}
    \begin{flalign*}
        \forall A \
        \left(
        ord \ A = \text{простое число}
        \longrightarrow
        A - \text{циклическая}
        \right)
	\end{flalign*}
    \begin{flalign*}
        &\forall n \
        GL_n(\mathbb{R}) \ \text{(общая линейная группа) - множества всех} \\
        &\text{невырожденных матриц размера} \ n \
        \text{с операцией матричного умножения}. \\
	\end{flalign*}
    \begin{flalign*}
        \forall n \
        SL_n(\mathbb{R}) \ \text{(специальная линейная группа)}
        =
        \set{A \in GL_n(\mathbb{R}) \mid det \ A = 1}
	\end{flalign*}
    \begin{flalign*}
        \forall n \
        D_n - \text{группа диэдра ($ R_i $ - поворот, $ u_j $ - осевая симметрия)}.
    \end{flalign*}
    \begin{flalign*}
        V_4 = D_2
	\end{flalign*}
    \begin{flalign*}
        ...
        \left\{
        \begin{aligned}
            &\left(K, \ +\right) - \text{абелева группа}. \\
            &\left(K, \ *\right) - \text{полугруппа}. \\
            &a, \ b, \ c \in K
            \longrightarrow
            \left\{
            \begin{aligned}
    ...
    \begin{flalign*}
        ...
        \begin{aligned}
            ...
            &\text{Корректность} \ *. \\
            &0 \in K \\
            &k \in K \longrightarrow k - \text{обратимый}.
        \end{aligned}
        \right.
        \Leftrightarrow
        K - \text{кольцо}.
        \right)
	\end{flalign*}
    Во всех кольцах, кроме кольца с одним элементом,
    не существует обратного к нулю.
    \begin{flalign*}
        \forall a \
        \left(
        \exists n \
    ...
    \begin{flalign*}
        ...
        \left\{
        \begin{aligned}
            &R - \text{коммутативное кольцо с единицей}. \\
            &a \in R
        \end{aligned}
        \right.
        \Leftrightarrow
        \meta{a} = a R - \text{главный идеал}.
        \right)
	\end{flalign*}
    \begin{flalign*}
        \forall I \
    ...
    \begin{flalign*}
        ...
        \begin{aligned}
            &K - \text{кольцо}. \\
            &k \neq 0 \longrightarrow k - \text{обратимый}. \\
            &a, \ b \in K \longrightarrow a b = b a
        \end{aligned}
        \right.
        \Leftrightarrow
        K - \text{поле}.
    ...
    \begin{flalign*}
        ...
        K - \text{поле}
        \Leftrightarrow
        char \ K = \text{количество 1, которые нужно сложить, чтобы получился} \ 0.
        \right)
	\end{flalign*}
    \begin{flalign*}
        \forall K \
    ...
    \begin{flalign*}
        ...
        \begin{aligned}
            &(V, E) - \text{граф} \\
            &V - \text{множество вершин} \\
            &E - \text{отношение смежности}
        \end{aligned}
        \right. \\
        &\set{x, y} \in \mathcal{P}_2(V) - \text{ребро графа} \iff x E y \\
        &\mathcal{E} = \set{\set{x, y} \in \mathcal{P}_2(V) \mid x E y} \\
        &|\mathcal{E}| = \frac{|E|}{2} - \text{размер графа} \\
        &|V| - \text{порядок графа} \\
        &(n, m) \ \text{граф}
        \iff
        \left\{
        ...
        \end{aligned}
        \right. \\
        &K_n = (\overline{n}, n^2 \backslash id) - \text{полный граф} \\
        &N(x) = \set{y \in V \mid x E y} - \text{окрестность} \ x \\
        &d(x) = |N(x)| - \text{степень} \ x \\
        &|V| = n \implies d(x) \leq n - 1
    \end{flalign*}
    Полный граф - это $ (n, C_n^2) $ граф. \\
    \textbf{Лемма о рукопожатиях:}
    \begin{flalign*}
        &\sum_{x \in V} d(x) = |E| \\
        &d(v_i) \geq d(v_{i + 1}) \iff \set{v_j} - \text{степенная последовательность} \\
        &\left\{
        \begin{aligned}
            &\varphi: V_G \rightarrow V_H \\
            &V_G \sim V_H \\
            &x E_G y \iff \varphi(x) E_H \varphi(y)
        \end{aligned}
        \right.
        \iff
        \varphi - \text{изоморфизм графов} \ G \ \text{и} \ H \\
        &O_n = (\underline{n}, \varnothing) - \text{пустой граф} \\
        &P_n
        = \\
        &(
        \underline{n},
        \set{(0, 1), (1, 0), (1, 2), (2, 1), \ldots, (n - 2, n - 1), (n - 1, n - 2)}
        )
        -
        \text{граф-путь (цепь)} \\
        &C_n
        ...
        (
        \underline{n},
        \set{(0, 1), (1, 0), (1, 2), (2, 1), \ldots, (n - 2, n - 1), (n - 1, 0)}
        )
        -
        \text{граф-цикл} \\
        &\left\{
        ...
        \begin{aligned}
            &V' \subseteq V \\
            &E' \subseteq E \cap V'^2
        \end{aligned}
        \right.
        \iff
        (V', E') - \text{индуцированный подграф} \ (V, E) \\
        &\overline{G} = (V, (V^2 \ \backslash \ id_V) \ \backslash \ E)
        -
        \text{дополнение графа} \ G \\
        &G = (n, m) \ \text{граф} \ \iff \overline{G} = (n, C_n^2 - m) \ \text{граф} \\
        &V_1, \ldots, V_n - \text{путь} \iff \forall i \ V_i E V_{i + 1}
    \end{flalign*}
    Длина пути - это число рёбер. \\
    Путь из $ x $ и $ y $. \\
    $ x $ соединён с $ x $ путём длины 0.
    \begin{flalign*}
        &x \sim y \iff x, y \ \text{соединены} \\
        &v_1, \ldots, v_n - \text{простой}
        \iff
        \forall i, j \ i \neq j \implies v_i \neq v_j \\
        &x \sim y
        \implies
        \exists v_1, \ldots, v_n \ \text{простой путь между} \ x \ \text{и} \ y
    \end{flalign*}
    Простой путь - кратчайший путь.
    \begin{flalign*}
        &\sim \in Eq(V) \\
        &[x]_{\sim} - \text{компонента связности} \\
        &\left|G/\sim\right| = 1 \iff G \ \text{связен} \\
        &\begin{cases}
            v_1 = v_{n + 1} \\
            i \neq j \implies \set{v_i, v_{i + 1}} \neq \set{v_j, v_{j + 1}}
        \end{cases}
        \iff
        v_1, \ldots, v_n - \text{цикл}
    \end{flalign*}
    В простом цикле только первая и последняя вершины совпадают. \\
    Удалить ребро цикла в связенном графе
    $ \implies $
    количество компонент связности останется тем же. \\
    Удалить ребро цикла в связенном графе
    $ \implies $
    количество компонент связности равно $ 2 $.
    \begin{flalign*}
        (n, m) - \text{связный граф} \implies n - 1 \leq m
    \end{flalign*}
    Сумма степенной последовательности всегда чётная. \\
    Граф минимально связен $ \iff $ граф связен и удаление любого ребра
    даёт несвязный граф. \\
    Удаление ребра в минимально связном графе даёт ровно два минимально
    связных графа. \\
    \begin{flalign*}
        &(n, m) - \text{минимально связный граф}
        \implies
        m = n - 1 \\
        &G - \text{дерево}
        \iff
        ...
        \end{cases} \\
        &\iff \\
        &\text{любые две вершины соединены ровно 1 простым путём} \\
        &(V, E') - \text{остовное дерево графа} \ (V, E)
        \iff
        E' \subseteq E
    \end{flalign*}
    В любом связном графе имеется остовное дерево.
    \begin{flalign*}
        &(V, E) - \text{двудольный граф}
        \iff
        \exists V_1, V_2 \
        \begin{cases}
            V = V_1 \cup V_2 \\
            ...
            V_1 \neq \varnothing \neq V_2 \\
            \forall i \ x, y \in V_i \ \overline{x E y}
        \end{cases} \\
        &\begin{cases}
            c: V \rightarrow \underline{k} \\
            \forall x, y \ x E y \implies c(x) \neq c(y)
        \end{cases}
        \iff
        c - \text{раскраска} \ (V, E) \ \text{в} \ k \ \text{цветов} \\
        &G - k\text{-дольный граф}
        \implies
        \begin{cases}
            \exists \text{раскраска} \ G \ \text{в} \ k \ \text{цветов} \\
            \exists \text{раскраска} \ G \ \text{в} \ k + 1 \ \text{цвет} \\
            \vdots \\
        \end{cases} \\
        &
        \begin{cases}
        ...
        \left(
        \begin{aligned}
            &G - \text{двудольный граф} \\
            &\iff \\
            &\text{в $ G $ нет цикла нечётной длины} \\
            &\iff \\
            &\text{в $ G $ нет простого цикла нечётной длины}
        \end{aligned}
        \right) \\
        &(n, m) - \text{двудольный граф}
        \implies
        m = \sum_{x \in V_1} d(x) = \sum_{x \in V_2} d(x) \\
        &A \subseteq V^2
        \iff
        (V, A) - \text{ориентированный граф} \\
        &\begin{cases}
            (V, A) - \text{ориентированный граф} \\
            \overline{x A x} \\
            \forall x, y \in V \
            x \neq y \implies \left(x A y \iff \overline{y A x}\right)
        \end{cases}
        \iff
        (V, A) - \text{турнир}
    \end{flalign*}

    \chapter{Беспредельный}
    \begin{flalign*}
        &Seq = \mathbb{R}^\mathbb{N} \\
        &\Delta - \text{разностный оператор} \\
        &\Delta: Seq \rightarrow Seq \\
        &(\Delta a)_n = a_{n + 1} - a_n \\
        &\Delta^0 a = a \\
        &\Delta^{t + 1} a = \Delta(\Delta^t a) \\
        &(\Delta^t a)_n = \sum_{k = 0}^t (-1)^k C_t^k a_{n + t - k}
    \end{flalign*}
    $ Seq $ образует векторное пространство над полем $ \mathbb{R} $
    \begin{flalign*}
        &(a + b)_n = a_n + b_n \\
        &(\alpha a)_n = \alpha a_n \\
        &\Delta - \text{линейный оператор} \\
        &S - \text{оператор сдвига} \\
        &(S a)_n = a_{n + 1} \\
        &1 - \text{тождественный оператор} \\
        &1 a = a \\
        &0 - \text{константный оператор} \\
        &0 a = 0 \\
        &\sum - \text{оператор суммы} \\
        &Lim - \text{множестве линейных операторов} \ Seq \rightarrow Seq \\
        &\left(\sum a\right)_0 = 0 \\
        &\left(\sum a\right)_{n + 1} = \left(\sum a\right)_n + a_n \\
        &(P + Q)(a) = P a + Q a \\
        &(\alpha P)(a) = \alpha (P a) \\
        &P Q = P \circ Q \\
        &(Lim, +, *) - \text{векторное пространство над полем} \ \mathbb{R} \\
        &\Delta = S - 1 \\
        &\Delta^t = \sum_{k = 0}^t C_t^k (-1)^k S^{t - k} \\
        &a_{k + n} = \sum_{t = 0}^n \frac{(\Delta^t a)_k}{t!} n^{(t)} \\
        &n^{(0)} = 1 \\
        &a \ \text{удовлетворяет рекуррентному соотношению} \ \varphi \ \text{порядка} \
        k \geq 1 \\
        &\iff \\
        &\begin{cases}
            \varphi: \mathbb{R}^k \times \mathbb{N} \rightarrow \mathbb{R} \\
            a_{n + k} = \varphi(a_{n + k - 1}, a_{n + k - 2}, \ldots, a_n, n)
        \end{cases} \\
        &\varphi - \text{стационарное} \iff \varphi \ \text{не зависит от} \ n
    \end{flalign*}
    Если есть рекуррентное соотношение и начальные условия, то последовательность
    однозначно задана.
    \begin{flalign*}
        &a_n = p(n) - \text{многочлен степени} \ m > 0
        \implies
        a_{n + m + 1} = \sum_{k = 0}^m (-1)^k C_{n + 1}^{k + 1} a_{n + m - k} \\
        &\Delta(a_n b_n) = a_n \Delta b_n + b_{n + 1} \Delta a_n \\
        &\sum(a_n \Delta b_n) = (a_n b_n - a_0 b_0) - \sum(b_{n + 1} \Delta a_n)
    \end{flalign*}
    ...
    \begin{flalign*}
        \forall \lambda, \mu \in F \ x, y \in V \
        \left\{
        \begin{aligned}
            &\left(V, +\right) - \text{абелева группа}. \\
            &F - \text{поле}. \\
            &*: V \times F \longrightarrow V \\
            &1x = x \\
        ...
        \Leftrightarrow
        \begin{aligned}
            &V - \text{векторное пространство над} \\
            &\text{полем} \ F.
        \end{aligned}
    \end{flalign*}
    \begin{flalign*}
        \exists F \ \forall \lambda \in F \ x, y \in U \
        \left\{
        \begin{aligned}
            &x + y \in U \\
            &\lambda x \in U
        ...
        \right.
        \Leftrightarrow
        U \subseteq V \ (U \ \text{подпространство} \ V)
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
            &\lambda_1, \ldots, \lambda_k \in F \\
            &v_1, \ldots, v_k \in V
        \end{aligned}
        \right.
        \Leftrightarrow
        \begin{aligned}
            &\lambda_1 v_1 + \ldots + \lambda_k v_k - \text{линейная комбинация} \\
            &\text{векторов} \ v_1, \ldots, v_k \ \text{c коэффициентами} \ 
            \lambda_1, \ldots, \lambda_k.
        \end{aligned}
    \end{flalign*}
    \begin{flalign*}
        \meta{
        v_1, \ldots, v_k} = \set{\lambda_1 v_1 + \ldots + \lambda_k v_k
        \mid
        \forall i \ \lambda_i \in F
        } - \text{линейная оболочка}.
    \end{flalign*}
    \begin{flalign*}
        \exists \set{\lambda}, i \
        \left\{
        \begin{aligned}
            &\lambda_1 v_1 + \ldots + \lambda_k v_k = 0 \\
            &\lambda_i \neq 0
        \end{aligned}
        \right.
        \Leftrightarrow
        v_1, \ldots, v_k \ \text{линейно зависимы (л.з.)}.
    \end{flalign*}
    \begin{flalign*}
        \forall x \ \exists \set{\alpha} \
        x = \alpha_1 e_1 + \ldots \alpha_n e_n
        \Leftrightarrow
        e_1, \ldots, e_n - \text{полная система векторов}.
    \end{flalign*}
    Выяснить по набору векторов, являются ли они л.з. \\
    Алгоритм:
    \begin{enumerate}
        \item Записать координаты данных векторов по столбцам в матрицу.
        \item Найти ступенчатый вид.
        \item Есть свободные переменные $ \Leftrightarrow $ л.з.
    \end{enumerate}
    $ e_1, \ldots, e_n \in V$: \\
    $ e_1, \ldots, e_n $ - базис
    $ \Leftrightarrow $
    любые 2 из 3 достаточно в обратную сторону:
    \begin{enumerate}
        \item $ e_1, \ldots, e_n $ л.н.з.
        \item $ e_1, \ldots, e_n $ - полная система векторов.
        \item $ dim \ V = n $
    \end{enumerate}
    \begin{flalign*}
        e_1, \ldots, e_n - \text{базис в} \ V.
        \Leftrightarrow
        dim \ V = n \ (n - \text{размерность} \ V )
    \end{flalign*}
    \begin{flalign*}
        dim \ \mathbb{R}^n = n
    \end{flalign*}
    \begin{flalign*}
        ...
        \right.
        \longrightarrow
        \exists! \set{\alpha} \ x = \alpha_1 e_1 + \ldots + \alpha_n e_n
    \end{flalign*}
    \begin{flalign*}
        \left\{
        \begin{aligned}
        ...
        \right.
        \longrightarrow
        \forall i \ \alpha_i - \text{координата} \ x \ \text{относительно базиса} \
        e_1, \ldots, e_n.
    \end{flalign*}
    \begin{flalign*}
        \left(
    ...
    \begin{flalign*}
        C_{e \rightarrow e'} = C_{e \rightarrow \text{ст.}} C_{\text{ст.} \rightarrow e'}
    \end{flalign*}
    \begin{flalign*}
        L_1 + L_2
        =
    ...
    \begin{flalign*}
        ...
        \ : \
        \frac{C + C^T}{2} + \frac{C - C^T}{2} = C
    \end{flalign*}
    Дополнить набор векторов до базиса. \\
    Алгоритм:
    \begin{enumerate}
        \item Записать по столбцам исходный набор векторов.
        \item Приписать справа по столбцам стандартный базис.
        \item Найти ступенчатый вид.
    \end{enumerate}
    \begin{flalign*}
        \begin{aligned}
            &\forall x, y, x_1, x_2, x_2, y_1, y_2 \in V \\
            &\lambda, \mu \in \mathbb{R}
        \end{aligned} \
        \left\{
        \begin{aligned}
            &\beta: V \times V \longrightarrow \mathbb{R} \\
            &\beta\left(\lambda x_1 + \mu x_2, y\right)
            =
            \lambda \beta\left(x_1, y\right) + \mu \beta\left(x_2, y\right) \\
            &\beta\left(x, \lambda y_1 + \mu y_2\right)
            =
            \lambda \beta\left(x, y_1\right) + \mu \beta\left(x, y_2\right)
        \end{aligned}
        \right.
        \Leftrightarrow
        \beta - \text{билинейная форма}.
    \end{flalign*}
    \begin{flalign*}
        \sum_{i \ j} b_{i j} x_i y_j
        =
        \left(
        \begin{array}{r r r r}
            x_1 & x_2 & \ldots & x_n
        ...
        \right)
        -
        \text{билинейная форма}.
    \end{flalign*}
    \begin{flalign*}
        f - \text{билинейная форма матрицы} \ A.
        \longrightarrow
        A' = C_{e \rightarrow e'}^T AC_{e \rightarrow e'}
    \end{flalign*}
    Если не знаешь, какой базис, можно брать стандартный базис
    (\emph{правило с оговоркой}).
    \begin{flalign*}
        \exists f \
        \left\{
        \begin{aligned}
            &f - \text{билинейная форма}. \\
            &q(x) = f(x, x)
        \end{aligned}
        \right.
        \Leftrightarrow
        q - \text{квадратичная форма}.
    \end{flalign*}
    \textbf{Симметричная билинейная форма} - это билинейная форма из квадратичной,
    в которой симметричная и которая позволяет сделать биекцию из квадратичной в
    билинейную. \\
    \textbf{Каноническая квадратичная форма} - это форма, в которой
    только квадраты. \\
    \textbf{Симметрический метод Гаусса} \\
    Если нет квадратов, то нужно использовать матрицу перехода, равную
    $ E - 2E_{j j} + E_{i j} + E_{j i} $
    в зависимости от выбранного $ x_i x_j \ (i < j) $ в квадратичной форме. \\
    \textbf{Нормальная квадратичная форма} - это каноническая форма,
    в которой коэффициенты только 1, -1, 0. \\
    \textbf{Положительный индекс инерции} ($ i_+(q) $) - это количество 1
    в нормальной форме. \\
    \textbf{Отрицательный индекс инерции} ($ i_-(q) $) - это количество -1
    в нормальной форме.
    \textbf{Правило Якоба и критерий Сильвестра:}
    \begin{flalign*}
        \left\{
        \begin{aligned}
            &\Delta_0 = 1 \\
            &\Delta_1 = \left| a_{1 1} \right| \neq 0 \\
            &\Delta_2
            =
            \begin{array}{| r r |}
                a_{1 1} & a_{1 2} \\
        ...
        -
        \text{каноническая форма}.
    \end{flalign*}
    \begin{flalign*}
        \forall x \neq 0 \ q(x) > 0
        \Leftrightarrow
        q(x) - \text{положительно определённая квадратичная форма}
    \end{flalign*}
    \begin{flalign*}
        q(x) - \text{положительно определённая квадратичная форма}
        \Leftrightarrow
    ...
    \begin{flalign*}
        q(x) \geq 0
        \Leftrightarrow
        q(x) - \text{положительно полуопределённая квадратичная форма}
    \end{flalign*}
    \begin{flalign*}
        q(x) - \text{положительно полуопределённая квадратичная форма}
        \Leftrightarrow
    ...
    \end{flalign*}
    \begin{flalign*}
        \forall k \ \sequence{i_n} \ det A_{i_1, \ldots i_k}^{i_1, \ldots, i_k} \leq 0
        \longrightarrow
        q(x) - \text{положительно полуопределённая квадратичная форма}.
    \end{flalign*}
    \begin{flalign*}
    ...
    \begin{flalign*}
        ...
        \left(
        \begin{array}{r r r r}
            \left(\varphi(e_1)\right)_e
            &
            \left(\varphi(e_2)\right)_e
            &
            \ldots
            &
            \left(\varphi(e_n)\right)_e
        \end{array}
        \right)
    \end{flalign*}
    \begin{flalign*}
        A' = C_{e \longrightarrow e'}^{-1} A C_{e \longrightarrow e'}
    \end{flalign*}
    \begin{flalign*}
        Ker \ \varphi \subseteq V
    \end{flalign*}
    \begin{flalign*}
        Im \ \varphi \subseteq V
    \end{flalign*}
    \begin{flalign*}
        &A, C^{-1} A C - \text{подобные матрицы} \\
        &\left\{
        \begin{aligned}
            &\varphi(f_i) = \lambda_i f_i \\
            &f_i \neq 0
        \end{aligned}
        \right.
        \iff
        \left\{
        \begin{aligned}
            &f_i - \text{собственный вектор оператора} \\
            &\lambda_i - \text{собственное число (значение) оператора}
        \end{aligned}
        \right. \\
        &Spec \ \varphi = \set{\lambda_1, \ldots, \lambda_k}
        -
        \text{множество собственных чисел оператора} \\
        &det \ (A - \lambda E) = 0 - \text{характеристическое уравнение} \\
        &x_A(\lambda) = det \ (A - \lambda E) \\
        &V_a(A) = \set{\overline{x} \mid A\overline{x} = 1 \overline{x}}
        -
        \text{собственное подпространство}
        - \\
        &\text{множество собственных векторов,} \
        \text{отвечающих числу $a$ и ещё нулевой вектор} \\
        &1 \leq g.m.(\lambda_i) \leq a.m.(\lambda_i) \\
        &A^n = C D^n C^{-1} \\
        &\left\{
        \begin{aligned}
            &i = j \implies (e_i, e_j) = 1 \\
            &i \neq j \implies (e_i, e_j) = 0
        \end{aligned}
        \right.
        \iff
        e_1, \ldots, e_n - \text{ОНБ} \\
        &A \ \text{диагонализуема} \iff \forall i \ a.m.(\lambda_i) = g.m.(\lambda_i) \\
        &L^{\bot} = \set{y \mid \forall x \in L: (x, y) = 0} \\
        &A^* = \text{Г}^{-1} A^T \text{Г} \\
        &Ker \ A^* = (Im \ A)^{\bot} \\
        &Im \ A^* = (Ker \ A)^{\bot} \\
        &A = A^* \implies A = A^T \ \text{в ОНБ}
    \end{flalign*}
    У симметричной матрицы есть собственный ОНБ. \\
    Собственные числа симметричной матрицы всегда вещественные.
n + m - k\end{document}
