...
с.л.а.у. $=$ система линейных алгебраических уравнений
...
Совместная с.л.а.у. - это с.л.а.у., у которой существует решение.

Определённая с.л.а.у. - это с.л.а.у., у которой решение единственно.

Элементарное преобразование типа I - это поменять местами две строки с.л.а.у.

Элементарное преобразование типа II - это прибавить к строке другую, умноженную на
константу.

Эквивалентные с.л.а.у. ($a tilde b$) - это с.л.а.у., у которых одни и те же решения.
...
Теорема о дедукции: $Gamma tack.r A -> B$ тогда и только тогда, когда $Gamma, A tack.r
B$.
...
10 аксиома интуционисткая, но при наличии 11 выводится.
