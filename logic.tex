...
\begin{flalign*}
    \tx{idr} \ x
    =
    \set{(\alpha, \alpha) \in x \times x \mid \top}
\end{flalign*}
\begin{flalign*}
...
\begin{flalign*}
    ...
    &\tx{inv} \ \left(x \circ y\right) \equiv \tx{inv} \ y \circ \tx{inv} \ x \\
...
\begin{flalign*}
    ...
    &\tx{inf} \ x \ y \ \fnd{\exists z - \tx{$ x $-инфимум $ y $}}
    =
    \cup\set{\alpha \in y \mid \alpha - \tx{$ x $-инфимум $ y $}} \\
    &\tx{sup} \ x \ y \ \fnd{\exists z - \tx{$ x $-супремум $ y $}}
    =
    \cup\set{\alpha \in y \mid \alpha - \tx{$ x $-супремум $ y $}}
\end{flalign*}
\begin{flalign*}
    &x - \tx{$ y $-цепь}
    =
...
\begin{flalign*}
    ...
    z,
    \set {
    (\alpha, \beta) \in \mathcal{P} \ x \times \mathcal{P} \ x \mid \alpha \subseteq \beta
    }
    \right)
\end{flalign*}
\end{document}
