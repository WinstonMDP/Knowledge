...
\end{flalign*}
\begin{flalign*}
    &x - \tx{индуктивно-замкнутое относительно $ y $}
    = \\
    &\exists z
    \begin{cases}
        y - \tx{индуктивное определение над $ z $} \\
        x \subseteq z \\
        \exists w \ \forall i \in y, j \in x^w \ i_j \in x
    \end{cases}
\end{flalign*}
\begin{flalign*}
    &\tx{ind} \ x \ \fnd{x - \tx{индуктивное определение над $ y $}}
    = \\
    &\cap\set {\alpha \in \mathcal{P} \ y \mid \alpha
    -
    \tx{индуктивно-замкнутое относительно $ x $}}
\end{flalign*}
\begin{flalign*}
