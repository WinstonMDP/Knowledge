...
\begin{flalign*}
    ...
    &\tx{inf} \ x \ y \ \fnd{\exists z - \tx{$ x $-точная нижняя грань $ y $}}
    = \\
    &\cup\set{\alpha \in y \mid \alpha - \tx{$ x $-точная нижняя грань $ y $}} \\
    &\tx{sup} \ x \ y \ \fnd{\exists z - \tx{$ x $-точная верхняя грань $ y $}}
    = \\
...
\begin{flalign*}
    ...
    \begin{cases}
        y - \tx{нестрогий порядок} \\
        \forall z \in x, w \in x \ (z, w) \in y \to z \equiv w
    \end{cases}
\end{flalign*}
\begin{flalign*}
...
\begin{flalign*}
    ...
    \begin{cases}
        ...
        \forall z \in x, w \in x
        \begin{cases}
            \exists i - \tx{$ y $-точная нижняя грань $ \set{z, w} $} \\
            \exists i - \tx{$ y $-точная верхняя грань $ \set{z, w} $}
        \end{cases}
    \end{cases}
\end{flalign*}
\begin{flalign*}
...
\end{flalign*}
\begin{flalign*}
    (x, y) - \tx{линейно упорядоченное множество}
    =
    \begin{cases}
        \begin{aligned}
            (x, y){ }-{ }&\tx{частично упорядоченное} \\
            &\tx{множество}
        \end{aligned} \\
        x - \tx{$ y $-цепь}
    \end{cases}
