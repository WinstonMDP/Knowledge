...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Если глагол первой формы заканчивается на "e"{}, "e" отбрасывается.
		\item Если глагол первой формы заканчивается на "ie"{}, "ie" заменяется на "y".
		\item Добавляется служебный глагол "to be".
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\item Добавляется служебный глагол have.
	\end{enumerate}
	...
	Если изначальное слово заканчивается на гласную + согласную, конечная
