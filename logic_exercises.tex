...
\begin{flalign*}
    x \subseteq y \times z \to w \circ x \equiv x \to w \upharpoonleft z \equiv \tx{id}_z
\end{flalign*}

\begin{flalign*}
    &\tx{intro} \ x \subseteq y \times z, w \circ x \equiv x \\
    &\tx{rewrite} \
    x \subseteq y \times z \to w \circ x \equiv x \to w \upharpoonleft z \equiv \tx{id}_z
    = \\
    &x \subseteq y \times z
    ...
    \to
    \begin{cases}
        \forall i \in w \upharpoonleft z \ i \in \tx{id}_z \\
        \forall i \in \tx{id}_z \ i \in w \upharpoonleft z
    \end{cases}
\end{flalign*}
...
\begin{flalign*}
    ...
    \end{cases} \\
    &\tx{intro} \ i \in w \upharpoonleft z \\
    &i \in w \\
    &\exists j \in z, k \ i \equiv (j, k) \\
    &\left(
    \exists t
    \begin{cases}
        (j, t) \in x \\
